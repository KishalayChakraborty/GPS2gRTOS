...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB10     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(GPIOA, AI_ADC1_Pin|AI_ADC2_Pin);

    HAL_GPIO_DeInit(GPIOB, EXT_B_SENSE_Pin|INT_B_SENSE_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, mcu_TXD_GSM_Pin|mcu_RXD_GSM_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, mcu_TXD_GPS_Pin|mcu_RXD_GPS_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB2     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOB, mcu_RXD_232_Pin|MCU_TXD_232_Pin);
